...
BEGIN
	...
	loopPersonal: loop    
		...
		insert into tveservicios2021_dev.personal values (maxPersonal+1,nempleado, paterno, materno, nombre, tipopersonal, null,  turno, activo, peraudit_insert, peraudit_insert);
        bloqueCuentas: begin        
			...
			loopCuenta: loop
                ...
                if numEmpleado = nempleado then
					...
					insert into tveservicios2021_dev.cuenta values (maxCuenta+1, maxPersonal+1,  usu, pass, cat_insert, cat_insert);
				end if;
...
BEGIN
	/*
	delete from tveservicios2021_dev.unidad_responsable;
    delete from tveservicios2021_dev.estado;
    
	insert into tveservicios2021_dev.unidad_responsable
	select null, urscve_pk ,ursnombre, ursnomcorto, urstipo, ursnivel,ursareaconoc, '2011-01-01 23:59:59', '2011-01-01 23:59:59'
	from tveserviciosRemota.cat_unidadresp;
    
    insert into tveservicios2021_dev.estado
    select estid_pk, estdescripcion, '2011-01-01 23:59:59', '2011-01-01 23:59:59'
    from tveserviciosRemota.estados;
    */
...
INSERT INTO tveservicios2021_dev.tipo_contrato (id, descripcion, audit_insert, audit_update) VALUES(1, 'Nómina', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tveservicios2021_dev.tipo_contrato (id, descripcion, audit_insert, audit_update) VALUES(2, 'Honorarios', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tveservicios2021_dev.tipo_contrato (id, descripcion, audit_insert, audit_update) VALUES(3, 'Freelance', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');

INSERT INTO tveservicios2021_dev.motivo_cancelacion (id, descripcion, audit_insert, audit_update) VALUES(1, 'Cancelado por el área solcicitante', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tveservicios2021_dev.motivo_cancelacion (id, descripcion, audit_insert, audit_update) VALUES(2, 'Falta de personal', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tveservicios2021_dev.motivo_cancelacion (id, descripcion, audit_insert, audit_update) VALUES(3, 'Falta de vehívulo', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tveservicios2021_dev.motivo_cancelacion (id, descripcion, audit_insert, audit_update) VALUES(4, 'Falta de combustible', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tveservicios2021_dev.motivo_cancelacion (id, descripcion, audit_insert, audit_update) VALUES(5, 'ECU cerrada', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
...
BEGIN
	...
	loopPersonal: loop    
        ...
        select  ifnull(max(id),0) into maxPersonal from tveservicios2021_dev.personal;
		insert into tveservicios2021_dev.personal values (maxPersonal+1,nempleado, paterno, materno, nombre, tipopersonal, 1, turno,  activo, null, null);     
        ...
        bloqueCuentas: begin        
			...
			loopCuenta: loop
                ...
                if numEmpleado = nempleado then
					select ifnull(max(id),0) into maxCuenta from tveservicios2021_dev.cuenta;
					insert into tveservicios2021_dev.cuenta values (maxCuenta+1, maxPersonal+1,  usu, pass, null, null);
				end if;
		        ...
		        bloqueCuentasRoles: begin        
					...
					loopCuentaRol: loop
		                ...
		                if nempleado = crEmpleado and nempleado = numEmpleado then
							insert into tveservicios2021_dev.cuenta_rol values (null, maxCuenta+1,  if(rolid=0,1, rolid), null, null);
						end if;
					end loop;
					CLOSE cur3;        
				end bloqueCuentasRoles;				
...
/*
			update tveservicios2021_dev.agenda_servicio set estado_id = 99
            where folioproductorasignado_id in (select distinct f.id 
            from tveservicios2021_dev.folio f
            inner join tveservicios2021_dev.folio_productor_asignado fpa on f.id = fpa.folio_id
...
INSERT INTO tveservicios2021_dev.ctacorreo (id, hostname, puerto, cuenta, contrasenia, auditinsert, auditlastupdate) VALUES(1, 'correo.ipn.mx', '587', 'epuente@ipn.mx', '', '2016-04-05 13:21:22.000', '2018-10-03 12:15:11.000');
