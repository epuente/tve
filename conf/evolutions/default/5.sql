...
INSERT INTO vtk_campo (id, audit_insert, audit_update, "label", nombre, indicaciones) VALUES(16, '2023-11-16 00:00:00.000', '2023-11-16 00:00:00.000', 'fechaProduccion', 'Fecha de producción', 'Escriba la fecha de producción en uno de los siguientes formatos:<br><br>dd/mm/yyyy<br>mm/yyyy<br>yyyy<br><br>Donde dd es para el día con dos dígitos, mm es para el mes con 2 dígitos, yyyy es para el año con 4 dígitos.');
