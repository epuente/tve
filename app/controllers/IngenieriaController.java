...
public class IngenieriaController extends ControladorSeguroIngeniero{
...
System.out.println(json);
	...
	*/
	...
	public static Result tableroIng(){		 
		System.out.println("desde UsuarioController.tableroIng");
		return ok( views.html.usuario.tableroIng.render());
	}

	public static Result ajaxTableroIng() throws JSONException{
		System.out.println("Desde UsuarioController.ajaxTableroIng");
	...
	public static Result misServicios(){
		return ok (views.html.usuario.misServicios.render(0L,0L));
	}
