...
/*!50003 DROP FUNCTION IF EXISTS `migracion` */;
...
BEGIN
    ...
    declare curPersonal  cursor for 
		select pernumempleado_pk, perpaterno, permaterno, pernombre, perturno, pertipopersonal_fk, peractivo, peraudit_insert from tves2016.cat_personal; 
	DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = 1;


    delete from tv2017.folio_productor_asignado;
	...
	loopPersonal: loop    
		...
		insert into tv2017.personal values (maxPersonal+1,nempleado, paterno, materno, nombre, tipopersonal, null,  turno, activo, peraudit_insert, peraudit_insert);
        bloqueCuentas: begin        
			DECLARE done2 INT DEFAULT 0;
            declare maxCuenta int;
			declare cur1 cursor for 
				SELECT ctapersonal_pf, ctausername_pk, ctapassword, tves2016.cuentas.ctaaudit_insert 
			...
			loopCuenta: loop
                ...
                if numEmpleado = nempleado then
					...
					insert into tv2017.cuenta values (maxCuenta+1, maxPersonal+1,  usu, pass, cat_insert, cat_insert);
				end if;
		        ...
		        bloqueCuentasRoles: begin        
					...
					declare cur3 cursor for select clrpersonal_pf, clrrol_fk, audit_insert from tves2016.cuentasroles where clrpersonal_pf = numempleado;            
					...
					loopCuentaRol: loop
		                ...
		                if nempleado = crEmpleado and nempleado = numEmpleado then
							insert into tv2017.cuenta_rol values (null, maxCuenta+1,  if(rolid=0,1, rolid), '2019-07-04 13:10:19', '2019-07-04 13:10:19');
						end if;
					end loop;
					CLOSE cur3;        
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `migracion00` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `migracion00`() RETURNS int(11)
BEGIN
	/*
	delete from tv2017.unidad_responsable;
    delete from tv2017.estado;
    
	insert into tv2017.unidad_responsable
	select null, urscve_pk ,ursnombre, ursnomcorto, urstipo, ursnivel,ursareaconoc, '2011-01-01 23:59:59', '2011-01-01 23:59:59'
	from tves2016.cat_unidadresp;
    
    insert into tv2017.estado
    select estid_pk, estdescripcion, '2011-01-01 23:59:59', '2011-01-01 23:59:59'
    from tves2016.estados;
    */
...
INSERT INTO tv2017.tipo_contrato (id, descripcion, audit_insert, audit_update) VALUES(1, 'Nómina', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tv2017.tipo_contrato (id, descripcion, audit_insert, audit_update) VALUES(2, 'Honorarios', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tv2017.tipo_contrato (id, descripcion, audit_insert, audit_update) VALUES(3, 'Freelance', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');

INSERT INTO tv2017.motivo_cancelacion (id, descripcion, audit_insert, audit_update) VALUES(1, 'Cancelado por el área solcicitante', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tv2017.motivo_cancelacion (id, descripcion, audit_insert, audit_update) VALUES(2, 'Falta de personal', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tv2017.motivo_cancelacion (id, descripcion, audit_insert, audit_update) VALUES(3, 'Falta de vehívulo', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tv2017.motivo_cancelacion (id, descripcion, audit_insert, audit_update) VALUES(4, 'Falta de combustible', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
INSERT INTO tv2017.motivo_cancelacion (id, descripcion, audit_insert, audit_update) VALUES(5, 'ECU cerrada', '2018-12-14 12:00:00.000', '2018-12-14 12:00:00.000');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `migracion001` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `migracion001`() RETURNS int(11)
BEGIN
    DECLARE nempleado, numEmpleado, paterno, materno, nombre, turno, tipopersonal, activo, usu, pass CHAR(100);
    DECLARE maxPersonal int;
    DECLARE done INT DEFAULT 0;
    ...
    delete from tv2017.cuenta_rol;
    delete from tv2017.cuenta;
    delete from tv2017.personal_horario;
	delete from tv2017.personal;
 
  
    delete from tv2017.operador_sala;
    delete from tv2017.personal;
	...
	loopPersonal: loop    
        ...
        select  ifnull(max(id),0) into maxPersonal from tv2017.personal;
		insert into tv2017.personal values (maxPersonal+1,nempleado, paterno, materno, nombre, tipopersonal, 1, turno,  activo, null, null);     
	...
	insert into tv2017.operador_sala (id, personal_id, sala_id, turno, audit_insert, audit_update) 
	select null, personal.id, sala.id,  atsturno_pk, '2013-02-07 11:38:58', '2013-02-07 11:38:58'
	from tves2016.atencionsala inner join tv2017.personal on atspersonal_pf = personal.num_empleado
	inner join tv2017.sala on atssala_pf = sala.id;     
RETURN 1;
END ;;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `migracion002Oficio` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `migracion002Oficio`() RETURNS int(11)
BEGIN
	...
	loopOficio: loop    
        ...
        if length(connombre) != 0 then
			...
			if length(concorreo) != 0 then
				insert into tv2017.oficio_contacto_correo values(null, maxOficioContacto+1, concorreo, ifnull(auditInsert,now()), ifnull(auditInsert,now()));
            end if;            
		end if;
        if length(fechagrabacion) != 0 then
			insert into tv2017.oficio_fecha_grabacion values(null, maxOficio+1, fechagrabacion, fechagrabacion, auditInsert, ifnull(auditInsert,now()));
		end if;
		...
		bloqueProductorAsignado: begin	
			...
			loopPA: loop    
				...
				if productorAsignado is not null then	
					select  ifnull(max(id),0) into maxFolioProductor from tv2017.folio_productor_asignado;
					insert into tv2017.folio_productor_asignado values (maxFolioProductor+1, maxFolio+1,  productorAsignado, auditInsert, ifnull(auditInsert,now()) );
				end if;
			end loop loopPA;
			close curPA;	
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `migracion003HisFolios` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `migracion003HisFolios`() RETURNS int(11)
BEGIN
    ...
    close curHisto;
    update tv2017.his_folio set estado_id=7 where estado_id=6;
RETURN 1;
END ;;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `migracion004Preagenda` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `migracion004Preagenda`() RETURNS int(11)
BEGIN	
...
from tv2017.oficio 	inner join tv2017.folio on oficio.id = folio.oficio_id 
					inner join tv2017.folio_productor_asignado on folio.id = folio_productor_asignado.folio_id
            ...
            delete from tv2017.pre_agenda_vehiculo;
            delete from tv2017.pre_agenda_tipo_personal;
			...
			loopPAS: loop    
                ...
                if ((fase=3) or (fase=4) )then
                    bloqueSalas: begin
						...
						loopSalas: loop
							...
							insert into tv2017.pre_agenda_sala values (maxPASSala+1, maxPAS+1, sala, auditInsertSala, auditInsertSala);
							if usoCabina != null or (length(usoCabina)!=0 ) then
								insert into tv2017.pre_agenda_sala_uso_cabina values (null, maxPASSala+1, usoCabina, ifnull(auditInsertSala,now()), ifnull(auditInsertSala,now()));
                            end if;
						end loop loopSalas;
						close curSalas;						
                    end bloqueSalas;
				...
				bloqueTP: begin
					...
					loopTP: loop
						...
						insert into tv2017.pre_agenda_tipo_personal values (null, maxPAS+1,  tipo, cantidad, auditInsertTP, auditInsertTP);
					end loop loopTP;
					close curTP;
				end bloqueTP;                 
				...
				bloqueV: begin
					...
					loopV: loop
						...
						insert into tv2017.pre_agenda_vehiculo values (null, maxPAS+1,  auditInsertV, auditInsertV);
					end loop loopV;
					close curV;
				end bloqueV;                  
			...
			close curPAS;
            update tv2017.folio set estado_id = 7 where estado_id = 6;
			update tv2017.pre_agenda set estado_id = 7 where estado_id = 6;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `migracion005Agenda` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `migracion005Agenda`() RETURNS int(11)
BEGIN	
...
from tv2017.oficio 	inner join tv2017.folio on oficio.id = folio.oficio_id 
					inner join tv2017.folio_productor_asignado on folio.id = folio_productor_asignado.folio_id
                    inner join tves2016.agendaservicio on agenumfolio_pf = tv2017.folio.folio
                    inner join tv2017.fase on agenfase_pf = fase.id;

			DECLARE CONTINUE HANDLER FOR NOT FOUND SET doneAServicio = 1; 
            
            delete from tv2017.agenda_servicio_vehiculo;
            delete from tv2017.agenda_servicio_personal;
            delete from tv2017.agenda_servicio_formato_entrega;
			delete from tv2017.agenda_servicio_accesorio;
            delete from tv2017.agenda_servicio_equipo;
            delete from tv2017.agenda_servicio_locacion;
            delete from tv2017.agenda_servicio_salida;
            delete from tv2017.agenda_servicio_sala_uso_cabina;
            delete from tv2017.agenda_servicio_sala;
            delete from tv2017.agenda_servicio;
			open curAS;
			loopAS: loop    
				...
				select  ifnull(max(id),0) into maxAS from tv2017.agenda_servicio;
				insert into tv2017.agenda_servicio values (maxAS+1, folioproductor,  fase, inicio, fin, estado, observacion, ifnull(auditInsertAS,now()), ifnull(auditInsertAS,now()), ifnull(auditInsertAS,now()));

                if ( (fase=1) or (fase=2)) then
					if salida != null or ( length(salida)!=0 and  substr(salida, 12)!='00:00:00')      then
						insert into tv2017.agenda_servicio_salida values (null, maxAS+1, salida, ifnull(auditInsertAS,now()), ifnull(auditInsertAS,now()));
					end if;
					if lugar!= null or (length(lugar)>1 and lugar!='na' and lugar!='no definido') then
						insert into tv2017.agenda_servicio_locacion values (null, maxAS+1, lugar, ifnull(auditInsertAS,now()), ifnull(auditInsertAS,now()));
					end if;   
					...
					bloqueV: begin
						...
						DECLARE curV cursor for 
                            ...
                            inner join tv2017.vehiculo on vesvehiculo_fk = vehiculo.placa
						...
						loopV: loop
							...
							#set monitor = concat("folio: ", convert(folio, char), " fase: ", convert(fase, char), "  sec: ",convert(secuencial,char));
							insert into tv2017.agenda_servicio_vehiculo values (null, maxAS+1,  vehiculo, auditInsertV, auditInsertV, auditInsertV);
						end loop loopV;
						close curV;
					end bloqueV;                    
					...
					if (fase=2) then
						...
						bloqueAccesorios: begin
							...
							loopAccesorios: loop
								...
								#set monitor = concat("folio: ", convert(folio, char), " fase: ", convert(fase, char), "  sec: ",convert(secuencial,char));
								insert into tv2017.agenda_servicio_accesorio values (null, maxAS+1,  accesorio, auditInsertAcc, auditInsertAcc);
							end loop loopAccesorios;
							close curAccesorios;
						end bloqueAccesorios;
						...
						bloqueEquipo: begin
							...
							loopEquipos: loop
								...
								insert into tv2017.agenda_servicio_equipo values (null, maxAS+1,  equipo, auditInsertEq, auditInsertEq);
							end loop loopEquipos;
							close curEquipos;
						end bloqueEquipo;                                            
					end if;   
                ...
                if (fase = 5) then
					...
					bloqueFmto: begin
						...
						DECLARE curFmtos cursor for 								
								...
								from tves2016.entregaformato inner join tv2017.folio on enfnumfolio_pf = folio.folio
						...
						loopFmtos: loop
                            ...
                            if cantidad >0 then
								insert into tv2017.agenda_servicio_formato_entrega values (null, maxAS+1,  formato, cantidad, auditInsertFmto, auditInsertFmto);
							end if;
						end loop loopFmtos;
						close curFmtos;
					end bloqueFmto; 					
				...
				bloqueP: begin
					...
					DECLARE curP cursor for 								
								...
								from tves2016.personalservicio  inner join tv2017.personal on pespersonal_pf = personal.num_empleado
					...
					loopP: loop
						...
						insert into tv2017.agenda_servicio_personal values (null, maxAS+1,  personal, auditInsertP, auditInsertP);
					end loop loopP;
					close curP;
				end bloqueP;                 
                ...
                if ((fase=3) or (fase=4) )then
                    bloqueSalas: begin
						...
						loopSalas: loop
                            ...
                            select  ifnull(max(id),0) into maxASSala from tv2017.agenda_servicio_sala;
							insert into tv2017.agenda_servicio_sala values (maxASSala+1, maxAS+1, sala, auditInsertSala, auditInsertSala);                             
							if usoCabina != null or (length(usoCabina)!=0 ) then
								insert into tv2017.agenda_servicio_sala_uso_cabina values (null, maxASSala+1, usoCabina, ifnull(auditInsertSala,now()), ifnull(auditInsertSala,now()));						
                            end if;
						end loop loopSalas;
						close curSalas;						
                    end bloqueSalas;                
			...
			update tv2017.agenda_servicio set estado_id = 7 where estado_id = 6;
/*
			update tv2017.agenda_servicio set estado_id = 99
            where folioproductorasignado_id in (select distinct f.id 
            from tv2017.folio f
            inner join tv2017.folio_productor_asignado fpa on f.id = fpa.folio_id
            where f.estado_id = 99);
*/

INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(329, 1, 2, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2019-02-06 09:04:12.000', '2019-02-06 09:04:12.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(328, 5, 2, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2019-02-06 09:03:15.000', '2019-02-06 09:03:15.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(322, 74, 2, '1970-01-01 15:00:00.000', '1970-01-01 21:00:00.000', '2018-12-17 10:34:31.000', '2018-12-17 10:34:31.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(323, 74, 3, '1970-01-01 15:00:00.000', '1970-01-01 21:00:00.000', '2018-12-17 10:34:31.000', '2018-12-17 10:34:31.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(324, 74, 4, '1970-01-01 15:00:00.000', '1970-01-01 21:00:00.000', '2018-12-17 10:34:31.000', '2018-12-17 10:34:31.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(325, 74, 5, '1970-01-01 15:00:00.000', '1970-01-01 21:00:00.000', '2018-12-17 10:34:31.000', '2018-12-17 10:34:31.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(326, 74, 6, '1970-01-01 15:00:00.000', '1970-01-01 21:00:00.000', '2018-12-17 10:34:31.000', '2018-12-17 10:34:31.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(317, 33, 2, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-17 10:32:46.000', '2018-12-17 10:32:46.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(318, 33, 3, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-17 10:32:46.000', '2018-12-17 10:32:46.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(319, 33, 4, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-17 10:32:46.000', '2018-12-17 10:32:46.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(320, 33, 5, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-17 10:32:46.000', '2018-12-17 10:32:46.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(321, 33, 6, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-17 10:32:46.000', '2018-12-17 10:32:46.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(312, 46, 2, '1970-01-01 16:00:00.000', '1970-01-01 21:00:00.000', '2018-12-17 10:31:05.000', '2018-12-17 10:31:05.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(313, 46, 3, '1970-01-01 16:00:00.000', '1970-01-01 21:00:00.000', '2018-12-17 10:31:05.000', '2018-12-17 10:31:05.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(314, 46, 4, '1970-01-01 16:00:00.000', '1970-01-01 21:00:00.000', '2018-12-17 10:31:05.000', '2018-12-17 10:31:05.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(315, 46, 5, '1970-01-01 16:00:00.000', '1970-01-01 21:00:00.000', '2018-12-17 10:31:05.000', '2018-12-17 10:31:05.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(316, 46, 6, '1970-01-01 16:00:00.000', '1970-01-01 21:00:00.000', '2018-12-17 10:31:05.000', '2018-12-17 10:31:05.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(307, 51, 2, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-17 10:28:39.000', '2018-12-17 10:28:39.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(308, 51, 3, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-17 10:28:39.000', '2018-12-17 10:28:39.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(309, 51, 4, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-17 10:28:39.000', '2018-12-17 10:28:39.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(310, 51, 5, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-17 10:28:39.000', '2018-12-17 10:28:39.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(311, 51, 6, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-17 10:28:39.000', '2018-12-17 10:28:39.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(302, 30, 2, '1970-01-01 15:00:00.000', '1970-01-01 21:00:00.000', '2018-12-14 13:55:11.000', '2018-12-14 13:55:11.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(303, 30, 3, '1970-01-01 15:00:00.000', '1970-01-01 21:00:00.000', '2018-12-14 13:55:11.000', '2018-12-14 13:55:11.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(304, 30, 4, '1970-01-01 15:00:00.000', '1970-01-01 21:00:00.000', '2018-12-14 13:55:11.000', '2018-12-14 13:55:11.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(305, 30, 5, '1970-01-01 15:00:00.000', '1970-01-01 21:00:00.000', '2018-12-14 13:55:11.000', '2018-12-14 13:55:11.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(306, 30, 6, '1970-01-01 15:00:00.000', '1970-01-01 21:00:00.000', '2018-12-14 13:55:11.000', '2018-12-14 13:55:11.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(297, 42, 2, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-14 13:53:51.000', '2018-12-14 13:53:51.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(298, 42, 3, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-14 13:53:51.000', '2018-12-14 13:53:51.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(299, 42, 4, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-14 13:53:51.000', '2018-12-14 13:53:51.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(300, 42, 5, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-14 13:53:51.000', '2018-12-14 13:53:51.000');
INSERT INTO tv2017.personal_horario (id, personal_id, diasemana, desde, hasta, audit_insert, audit_update) VALUES(301, 42, 6, '1970-01-01 08:00:00.000', '1970-01-01 15:00:00.000', '2018-12-14 13:53:51.000', '2018-12-14 13:53:51.000');
		
		
INSERT INTO tv2017.ambito (id, descripcion, audit_insert, audit_update) VALUES(1, 'Administración Depto', '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.ambito (id, descripcion, audit_insert, audit_update) VALUES(2, 'Administración', '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.ambito (id, descripcion, audit_insert, audit_update) VALUES(3, 'Agendado', '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.ambito (id, descripcion, audit_insert, audit_update) VALUES(4, 'Emisión de Reportes', '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');


INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(1, 1, 1, 1, 1, 1, '2019-01-01', '2019-01-01');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(4, 10, 3, 1, 0, 0, '2019-01-01', '2019-01-01');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(6, 11, 3, 1, 0, 0, '2019-01-01', '2019-01-01');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(7, 12, 3, 1, 0, 0, '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(8, 13, 3, 1, 0, 0, '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(9, 14, 3, 1, 0, 0, '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(10, 15, 3, 1, 0, 0, '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(11, 16, 3, 1, 0, 0, '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(17, 17, 3, 1, 0, 0, '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(3, 100, 3, 1, 1, 1, '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(25, 126, 1, 1, 0, 0, '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');
INSERT INTO tv2017.rol_derecho (id, rol_id, ambito_id, lectura, escritura, ejecucion, audit_insert, audit_update) VALUES(2, 127, 2, 1, 1, 1, '2019-01-01 00:00:00.000', '2019-01-01 00:00:00.000');

INSERT INTO tv2017.ctacorreo (id, hostname, puerto, cuenta, contrasenia, auditinsert, auditlastupdate) VALUES(1, 'correo.ipn.mx', '587', 'epuente@ipn.mx', '', '2016-04-05 13:21:22.000', '2018-10-03 12:15:11.000');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `migracionDev` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `migracionDev`() RETURNS int(11)
BEGIN
DECLARE nempleado, numEmpleado, paterno, materno, nombre, turno, tipopersonal, activo, usu, pass CHAR(100);
    DECLARE maxPersonal int;
    DECLARE done INT DEFAULT 0;
